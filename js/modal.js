(function () {
  ...
  if (backdrop) {
    ...
    form.addEventListener("submit", function (event) {
      ...
      // The real backend only implements the `bouquets` resource (per the
      // assignment spec) — there's no `requests`/orders endpoint to persist
      // this to. We keep the form's UX intact and just confirm locally.
